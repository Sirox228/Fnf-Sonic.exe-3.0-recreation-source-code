...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "resizeWindow", function(widthlol:Int, heightlol:Int) {
			FlxG.resizeWindow(widthlol, heightlol);
		});
		
		Lua_helper.add_callback(lua, "resizeGame", function(widthlol:Int, heightlol:Int) {
			FlxG.resizeGame(widthlol, heightlol);
		});
		
		Lua_helper.add_callback(lua, "windowMove", function(xval:Int, yval:Int) {
