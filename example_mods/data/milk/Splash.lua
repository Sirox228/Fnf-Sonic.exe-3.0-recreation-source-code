...
function goodNoteHit(id, dir, type, sus)
    if dir == 0 and not sus then
        setProperty('splashLeft.x', getPropertyFromGroup('playerStrums', 0, 'x')-(200*0.7)*0.95)
        setProperty('splashLeft.y', getPropertyFromGroup('playerStrums', 0, 'y')-(230*0.7))
    ...
    elseif dir == 1 and not sus  then
        setProperty('splashDown.x', getPropertyFromGroup('playerStrums', 1, 'x')-(240*0.7)*0.95)
        setProperty('splashDown.y', getPropertyFromGroup('playerStrums', 1, 'y')-(230*0.7))
    ...
    elseif dir == 2 and not sus then
        setProperty('splashUp.x', getPropertyFromGroup('playerStrums', 2, 'x')-(240*0.7)*0.95)
        setProperty('splashUp.y', getPropertyFromGroup('playerStrums', 2, 'y')-(230*0.7))
    ...
    elseif dir == 3 and not sus then
        setProperty('splashRight.x', getPropertyFromGroup('playerStrums', 3, 'x')-(220*0.7)*0.95)
        setProperty('splashRight.y', getPropertyFromGroup('playerStrums', 3, 'y')-(230*0.7))
